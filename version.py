...
__version__ = "0.5.10-alpha_main_66-20260322-644d2f2"
...
def get_base_version():
    ...
    if "_" in __version__:
        ...
        # Add phase if specified (only for fallback, extraction already includes phase)
        if PHASE:
            base = f"{base}-{PHASE}"
